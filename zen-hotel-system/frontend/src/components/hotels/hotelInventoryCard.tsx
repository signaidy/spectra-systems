...
// Components
import { HotelInventoryDialog } from "@/components/hotels/hotelInventoryDialog";
// UI Components
import { Button } from "@/components/ui/button";
import { Star, MapPin } from "lucide-react";

export function HotelInventoryCard({
  hotel,
  searchParams,
}: {
  hotel: Hotel;
    ...
    <article className="border rounded-md grid-cols-[0.75fr_1fr] grid h-72">
      ...
      <div className="flex flex-col justify-between rounded-r-md bg-background">
        <div className="flex flex-col gap-y-1 p-4 h-full">
          ...
          <HotelInventoryDialog hotel={hotel} searchParams={searchParams} />
        </div>
