...
function generatePDF(purchase_number, ticket, type, origin, destination, purchase_date, price, paymenth_method, arrival_date, departure_date, user_name) {
const doc = new jsPDF();
doc.text(purchase_number, 10, 10);
doc.save("a4.pdf");
}
  ...
  <div class="p-10">
    ...
    >
      ...
      <button
        ...
        on:click={() => generatePDF(purchase_number, ticket, type, origin, destination, purchase_date, price, paymenth_method, arrival_date, departure_date, user_name)}
