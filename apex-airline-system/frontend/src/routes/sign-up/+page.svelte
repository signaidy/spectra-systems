<div class="bg-blue-200 w-full min-h-screen flex items-center justify-center">
	<div class="w-full py-8">
		<div class="flex items-center justify-center space-x-2">
			<img
				src="https://www.allegiantair.jobs/wp-content/uploads/2021/10/logo.svg"
				title="logo"
				alt="logo"
			/>
			<!-- <h1 class="text-3xl font-bold text-blue-600 tracking-wider"></h1> -->
		</div>
		<div
		...
		>
			...
			<form class="my-8 text-sm">
				...
				<!-- Missing logic for date selection -->
				<div class="flex flex-col my-4">
				...
				<!-- Missing options for countries selection -->
				<div>
					<label for="countries" class="text-gray-700">Select an option</label>
					<select
						id="countries"
						class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:focus:ring-blue-500 dark:focus:border-blue-500"
					>
				...
				<div class="flex flex-col my-4">
					<label for="pasport" class="text-gray-700">Pasport number</label>
					<input
						type="pasport"
						name="pasport"
						id="pasport"
				...
				<div class="flex items-center">
					...
					<label for="remember_me" class="text-gray-700"
						>I accept the <a href="#" class="text-blue-600 hover:text-blue-700 hover:underline"
							>terms</a
						>
						and
						<a href="#" class="text-blue-600 hover:text-blue-700 hover:underline">privacy policy</a
						></label
					>
				</div>
